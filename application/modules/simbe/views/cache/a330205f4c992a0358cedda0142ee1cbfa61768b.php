    ...
    <table id="penerima" class="table table-striped table-bordered dt-responsive " style="border-collapse: collapse; border-spacing: 0; width: 100%">
        <thead>
            <tr>
                ...
                <th style="width: 19%">Approval BKAL</th>
                <th style="width: 19%">Approval Dosen</th>
                <th style="width: 19%">Approval Kaprodi</th>
                <th style="width: 19%">Approval Wakil Rektor</th>
                <th>Status</th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\simbea\application\modules\simbe\views/admin/dashboard.blade.php ENDPATH**/ ?>