    ...
    <table id="penerima" class="table table-striped table-bordered dt-responsive " style="border-collapse: collapse; border-spacing: 0; width: 100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                {{-- <td>{{ $data->nama_prodi }}</td> Approval BKAL --}}
                {{-- <td>{{ $data->nama_prodi }}</td> Approval Dosen --}}
                {{-- <td>{{ $data->nama_prodi }}</td> Approval Kaprodi --}}
                {{-- <td>{{ $data->nama_prodi }}</td> Approval Wakil Rektor --}}
                <td>
