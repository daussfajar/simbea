...
<body>
     ...
     <div id="wrapper">
          ...
          <div class="navbar-custom">
               ...
               <!-- LOGO -->
			<div class="logo-box">
				<a href="{{ base_url('user/dashboard') }}" class="logo text-center">
					<span class="logo-lg">
		...
		<div class="left-side-menu">
			...
			<div id="sidebar-menu">
				...
				<ul class="metismenu" id="side-menu">
					...
					<li>
						<a href="{{ base_url('user/dashboard') }}" class="waves-effect waves-light">
					...
					<li>
						...
						<ul class="nav-second-level" aria-expanded="false">
						    <li><a href="{{ base_url('user/prestasi') }}">Prestasi Akademik</a></li>
						    <li><a href="{{ base_url('user/capaian') }}">Capaian Non Akademik</a></li>
						    <li><a href="{{ base_url('user/biaya') }}">Biaya Pendidikan</a></li>
						</ul>
					</li>
				</ul>
